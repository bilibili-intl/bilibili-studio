...
// static
FundamentalValue* Value::CreateIntegerValue(/*bililive[int*/int64/*]bililive*/ in_value) {
  return new FundamentalValue(in_value);
}
...
FundamentalValue::FundamentalValue(/*bililive[int*/int64/*]bililive*/ in_value)
...
bool FundamentalValue::GetAsInteger(int* out_value) const {
  if (out_value && IsType(TYPE_INTEGER))
    ...
    *out_value = static_cast<int>(integer_value_);
    // ]bililive
...
ValueMap::iterator DictionaryValue::begin()
{
    return dictionary_.begin();
}

ValueMap::iterator DictionaryValue::end()
{
    return dictionary_.end();
}

ValueMap::const_iterator DictionaryValue::begin() const
{
    return dictionary_.begin();
}

ValueMap::const_iterator DictionaryValue::end() const
{
    return dictionary_.end();
}
...
// bililive[
void DictionaryValue::SetInteger64WithoutPathExpansion(
...
// bililive[
bool DictionaryValue::GetInteger64(const std::string& path, int64* out_value) const {
    const Value* value;
    if (!Get(path, &value))
        return false;
...
// bililive[
void ListValue::AppendInteger64(int64 in_value) {
  Append(CreateIntegerValue(in_value));
}
// ]bililive
