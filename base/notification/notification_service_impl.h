#ifndef BASE_NOTIFICATION_NOTIFICATION_SERVICE_IMPL_H
#define BASE_NOTIFICATION_NOTIFICATION_SERVICE_IMPL_H
...
namespace base{
  ...
  class BASE_EXPORT NotificationServiceImpl : public NotificationService {
  public:
