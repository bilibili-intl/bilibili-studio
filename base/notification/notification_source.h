#ifndef BASE_NOTIFICATION_NOTIFICATION_SOURCE_H
#define BASE_NOTIFICATION_NOTIFICATION_SOURCE_H
...
namespace base{
  ...
  class BASE_EXPORT NotificationSource {
  public:
...
#endif  // BASE_NOTIFICATION_NOTIFICATION_SOURCE_H
