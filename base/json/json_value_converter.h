...
// bililive[
template <>
class BasicValueConverter<int64> : public ValueConverter<int64> {
public:
    BasicValueConverter() {}

    virtual bool Convert(const base::Value& value, int64* field) const OVERRIDE {
        return value.GetAsInteger64(field);
    }
