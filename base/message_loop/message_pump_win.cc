...
void MessagePumpWin::EventSpared(){
    FOR_EACH_OBSERVER(MessagePumpObserver, observers_, EventSpared());
}
...
void MessagePumpWin::SetWaitMsg(bool wait)
{
    wait_msg_ = wait;
}
...
bool MessagePumpForUI::ProcessMessageHelper(const MSG& c_msg) {
    MSG msg = c_msg;
