...
struct obs_source {
	...
	// bililive [
    deferred_updated_callback deferred_updated_handler;
    void* deferred_updated_handler_param;
	// ]
...
struct obs_encoder {
	...
	// bililive [
	pthread_mutex_t                 pkt_filter_mutex;
	DARRAY (encoder_packet_filter_info *) pkt_filter_info;
	DARRAY (void *) pkt_filter;
	// ]
};
