...
// bililive[
typedef base::Callback<base::FilePath(const base::FilePath&)> ReplaceCallback;
typedef base::Callback<std::string(const std::string&)> NewFilePathCallback;
// ]
...
// bililive[
bool Unzip_64(const base::FilePath& zip_file, const base::FilePath& dest_dir);
// ]bililive
