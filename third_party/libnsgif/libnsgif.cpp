...
*/        gif_data += 3;
        ...
        gif->global_colours = 0 != (gif_data[4] & GIF_COLOUR_TABLE_MASK);
                ...
                if (burst_bytes > 0) {
                    ...
                    while (burst_bytes-- > 0) {
						...
						if (((gif->frames[frame].transparency) &&
							...
							((unsigned char*)frame_scanline)[0] =  ((unsigned char*)(colour_table + colour))[2];
							((unsigned char*)frame_scanline)[1] =  ((unsigned char*)(colour_table + colour))[1];
							((unsigned char*)frame_scanline)[2] = ((unsigned char*)(colour_table + colour))[0];
							((unsigned char*)frame_scanline)[3] = 255; // ((unsigned char*)(colour_table + colour))[3];
						}
                        frame_scanline++;
                    }
                } else {
