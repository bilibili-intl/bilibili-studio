...
namespace {
    ...
    const std::string kBackGroundColor = "22C0FA";
...
GiftPanelTitleView::GiftPanelTitleView()
{
}
...
void GiftPanelTitleView::SetDelegate(GiftPanelTitleDelegate* delegate, bool opaque)
{
    delegate_ = delegate;
    opaque_ = true;//opaque;
    if (opaque_) {
...
void GiftPanelTitleView::ChangeBackGround(const std::string& color_value)
{
    if (!opaque_) {
        return;
    }
...
int GiftPanelTitleView::GetColorValue(const std::string& color_value)
{
    int color = 0;
...
void GiftPanelTitleView::SetTitleContent(const base::string16& title, const std::string& title_color, const std::string& icon, bool re_layout)
{
    if (!title.empty()) {
...
void GiftPanelTitleView::SetTitleBar(const CefTitleBar& cef_title_bar)
{
    //ÉèÖÃ±êÌâÀ¸
...
bool GiftPanelTitleView::ControlCommonType(CommonType common_type, TitleCtl title_ctl)
{
...
void GiftPanelTitleView::InitView()
{
...
void GiftPanelTitleView::Layout()
{
...
void GiftPanelTitleView::ButtonPressed(views::Button* sender, const ui::Event& event)
{
    if (!delegate_) {
        return;
    }
...
bool GiftPanelTitleView::OnMouseDragged(const ui::MouseEvent& event)
{
...
bool GiftPanelTitleView::OnMousePressed(const ui::MouseEvent& event)
{
...
void GiftPanelTitleView::OnMouseReleased(const ui::MouseEvent& event)
{
...
void GiftPanelTitleView::OnOpacityChanged()
{
