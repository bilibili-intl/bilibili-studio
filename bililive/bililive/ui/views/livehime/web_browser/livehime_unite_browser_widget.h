#ifndef BILILIVE_BILILIVE_UI_VIEWS_LIVEHIME_UNITE_BROWSER_WIDGET_H_
#define BILILIVE_BILILIVE_UI_VIEWS_LIVEHIME_UNITE_BROWSER_WIDGET_H_
...
#include "bililive/bililive/ui/views/controls/browser/livehime_web_browser_view.h"
#include "bililive/bililive/ui/views/livehime/web_browser/common/module_common_title.h"
...
{
public:
    explicit BililiveUniteBrowserView(const hybrid_ui::LivehimeWebUrlDetails& url_ex,
...
protected:
    ...
    void FollowCloudTitleMove() override;
    void SendMouseEvent(const ui::MouseEvent& event) override;
...
private:
    ...
    ModuleCommonTitleView* common_title_ = nullptr;
    SecondaryWindowTitleView* second_title_ = nullptr;      //二级弹窗标题栏,标题栏单例待优化
    ...
    base::WeakPtrFactory<BililiveUniteBrowserView> weak_wpf_;
