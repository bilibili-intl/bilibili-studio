...
namespace
{
    ...
    // ----------------------------------------------------------------------------
    // Defaults for properties which are stored in the bililive theme pack. If you
    // change these defaults, you must increment the version number in
    // bililive_theme_pack.h
    ...
    // ----------------------------------------------------------------------------
    // Defaults for properties which are not stored in the bililive theme pack.
    ...
    // bililive_theme_pack.cc, and you should assign persistent IDs to the
...
bool ThemeProperties::IsThemeableImage(int id)
{
    ...
    BililiveThemePack::GetThemeableImageIDRs(&themeable_idrs);
