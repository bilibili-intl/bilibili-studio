...
PROTOBUF_NAMESPACE_OPEN
template<> ::bilibili::rpc::Status* Arena::CreateMaybeMessage<::bilibili::rpc::Status>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace bilibili {
namespace rpc {
...
class Status final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.rpc.Status) */ {
 public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Status::code() const {
  // @@protoc_insertion_point(field_get:bilibili.rpc.Status.code)
...
inline void Status::set_code(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:bilibili.rpc.Status.code)
}
...
inline const std::string& Status::message() const {
  // @@protoc_insertion_point(field_get:bilibili.rpc.Status.message)
...
void Status::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:bilibili.rpc.Status.message)
}
inline std::string* Status::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:bilibili.rpc.Status.message)
  return _s;
}
...
inline std::string* Status::release_message() {
  // @@protoc_insertion_point(field_release:bilibili.rpc.Status.message)
...
inline void Status::set_allocated_message(std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:bilibili.rpc.Status.message)
}
...
inline PROTOBUF_NAMESPACE_ID::Any* Status::mutable_details(int index) {
  // @@protoc_insertion_point(field_mutable:bilibili.rpc.Status.details)
  return details_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< PROTOBUF_NAMESPACE_ID::Any >*
Status::mutable_details() {
  // @@protoc_insertion_point(field_mutable_list:bilibili.rpc.Status.details)
  return &details_;
}
...
inline const PROTOBUF_NAMESPACE_ID::Any& Status::details(int index) const {
  // @@protoc_insertion_point(field_get:bilibili.rpc.Status.details)
...
inline PROTOBUF_NAMESPACE_ID::Any* Status::add_details() {
  ...
  // @@protoc_insertion_point(field_add:bilibili.rpc.Status.details)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< PROTOBUF_NAMESPACE_ID::Any >&
Status::details() const {
  // @@protoc_insertion_point(field_list:bilibili.rpc.Status.details)
  return details_;
}
