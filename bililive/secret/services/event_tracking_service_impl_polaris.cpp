...
namespace secret
{
    RequestProxy EventTrackingServiceImpl::ReportLivehimeBehaviorEventPolaris(
        LivehimePolarisBehaviorEvent event_id,
        const base::StringPairs& event_ext)
    {
        return ReportLivehimeBehaviorEventPolaris(kLivehimeBehaviorEventPolarisTable.at(event_id), event_ext);
    }
