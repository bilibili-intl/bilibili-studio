...
namespace secret
{
    RequestProxy EventTrackingServiceIntlImpl::ReportLivehimeBehaviorEventViaSrv(
    ...
    RequestProxy EventTrackingServiceIntlImpl::ReportLivehimeBehaviorEventViaSrvNew(
