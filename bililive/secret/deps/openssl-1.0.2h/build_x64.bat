...
:set env="C:\Program Files (x86)\Microsoft Visual Studio 12.0\VC\bin\vcvars64.bat"
set env="C:\Program Files (x86)\Microsoft Visual Studio\2019\Professional\VC\Auxiliary\Build\vcvars64.bat"
call %env%
set VisualStudioVersion=16.11.5

call nmake -f ms\ntdll.mak install

set build_lib_dir="build\lib\"
set dep_lib_dir="..\x64\lib\"
copy /Y %build_lib_dir%\libeay32.lib %dep_lib_dir%
copy /Y %build_lib_dir%\ssleay32.lib %dep_lib_dir%

set build_bin_dir="build\bin\"
set dep_bin_dir="..\x64\bin\"
