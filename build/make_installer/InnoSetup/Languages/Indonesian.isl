...
KUninstall=Hapus Pemasangan %1
KInstalling=Sedang Memasang
KInstallApp=%1 Program Pemasang
DeleteProfile=Apakah sekalian hapus fail konfigurasi?
CheckInValidFolder=Bilibili Studio (Beta) terdeteksi tidak terpasang di folder livehime atau bililive, demi menghindari kesalahan penghapusan fail%n%nYakin untuk menghapus seluruh %1 data program di dalam direktori?
WaitCurInstallFinish=Mohon tunggu pemasangan atau penghapusan pemasangan %1 saat ini selesai
ApplicationRuningWhenUninstall=Program pemasang mendeteksi %1 sedang beroperasi.%n%nAnda harus menutupnya lalu mengeklik "Ya" untuk melanjutkan pemasangan atau "Tidak" untuk logout!
ApplicationRuningWhenInstall=Program pemasang mendeteksi %1 sedang beroperasi.%n%nAnda harus menutupnya lalu mengeklik "Ya" untuk melanjutkan pemasangan atau "Tidak" untuk logout!
IncompatibleVersion=Perpaduan gagal dengan %1 v%2 versi sebelumnya terdeteksi%n%nMohon hapus pemasangan versi sebelumnya, lalu lakukan pemasangan kembali
HasHigerVersion=Anda telah memasang versi %1 v%2 yang lebih baru
WindowsRunLevel=%1 Wajib dioperasikan di Sistem Operasi Windows 7 dan ke atas
InvalidInstallPath=Jalur Pemasangan Salah!
CantIntsallInRootFolder=Program aplikasi tak bisa dipasang di direktori akar!
MayConflictWithOther=Pemasangan Bilibili Studio (Beta) pada direktori di luar bililive atau livehime berpotensi menyebabkan konflik di antara program%n%nApakah lanjut memasang?