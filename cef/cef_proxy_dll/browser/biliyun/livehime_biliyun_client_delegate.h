...
class LivehimeBiliyunClientDelegate : public LivehimeCefClientBrowser::Delegate
{
public:
    explicit LivehimeBiliyunClientDelegate(const cef_proxy::browser_bind_data& bind_data);
    virtual ~LivehimeBiliyunClientDelegate();
...
private:
    ...
    IMPLEMENT_REFCOUNTING(LivehimeBiliyunClientDelegate);
    DISALLOW_COPY_AND_ASSIGN(LivehimeBiliyunClientDelegate);
};