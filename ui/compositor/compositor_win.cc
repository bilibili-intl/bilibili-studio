...
#include "gfx/grit/gfx_resources.h"
...
class CompositorWin : public Compositor {
 public:
  ...
  void UpdatePerspective(const gfx::Transform& transform,
...
void CompositorWin::UpdatePerspective(const gfx::Transform& transform,
                                      const gfx::Size& view_size) {
