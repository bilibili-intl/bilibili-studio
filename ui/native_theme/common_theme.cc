...
// MenuItem:
const SkColor kMenuBackgroundColor = SkColorSetRGB(22, 22, 31);
...
const SkColor kMenuInvertedSchemeHighlightBackgroundColor = SkColorSetRGB(48, 48, 48);
...
const SkColor kMenuSeparatorColor = SkColorSetRGB(0x00, 0x00, 0x00);
const SkColor kEnabledMenuItemForegroundColor = SkColorSetRGB(22, 22, 31);
const SkColor kDisabledMenuItemForegroundColor = SkColorSetRGB(161, 161, 146);
const SkColor kHoverMenuItemBackgroundColor = SkColorSetRGB(0, 0, 0);
