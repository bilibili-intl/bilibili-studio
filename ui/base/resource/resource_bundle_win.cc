...
void ResourceBundle::LoadCommonResources() {
  ...
  //        "bililive_touch_180_percent.pak"),
  //        SCALE_FACTOR_180P);
  //    force_touch_resources = true;
  //    break;
  //  case ui::SCALE_FACTOR_140P:
  //    AddDataPackFromPath(GetResourcesPakFilePath(
  //        "bililive_touch_140_percent.pak"),
  //        SCALE_FACTOR_140P);
  //    force_touch_resources = true;
  //}
  ...
  //  AddDataPackFromPath(
  //      GetResourcesPakFilePath("bililive_touch_100_percent.pak"),
  //      SCALE_FACTOR_100P);
  //}
  //else
  // ]bililive
  {
      ...
      // ]bililive
          AddDataPackFromPath(
              GetResourcesPakFilePath("bililive_100_percent.pak"),
              SCALE_FACTOR_100P);
      // bililive[
      } else if (scale >= 1.5f && scale < 2.f) {
          AddDataPackFromPath(
              GetResourcesPakFilePath("bililive_150_percent.pak"),
              SCALE_FACTOR_100P);
      } else {
          AddDataPackFromPath(
              GetResourcesPakFilePath("bililive_200_percent.pak"),
              SCALE_FACTOR_100P);
      }
      // ]bililive
  }
