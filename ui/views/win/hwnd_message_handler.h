...
class VIEWS_EXPORT HWNDMessageHandler :
 ...
 public:
  ...
  // bililive[
  void set_disable_redraw_when_did_process_msg(bool disable) {
    disable_redraw_when_did_process_msg_ = disable;
  }
  // ]bililive
  ...
  void set_use_new_translucent(bool use_new_translucent) {
    use_new_translucent_ = use_new_translucent;
  }
 ...
 private:
  ...
  virtual void EventSpared() OVERRIDE {}
  ...
  // bililive[
  bool disable_redraw_when_did_process_msg_ = false;
  // ]bililive

  bool use_system_default_icon_;

  // bililive[
  bool use_new_translucent_ = false;
  HRGN blur_rgn_ = nullptr;
  // ]bililive
  ...
  // bililive[
  bool is_maximum_fill_work_aera_;
  // ]bililive
