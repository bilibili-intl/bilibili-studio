...
class VIEWS_EXPORT View : public ui::LayerDelegate,
 ...
 public:
  ...
  // bililive [ RemoveChildView do not call ViewHierarchyChanged
  void RemoveChildViewCancelNotifications(View* view);
  // ]
  ...
  //bililive[
  void KeyEventDispatch(ui::KeyEvent* event);
  virtual bool OnIMEMessage(const MSG event, LRESULT* result);
  ...
  bool OnUntranslatedIMEMessage(const MSG event, LRESULT* result);
  //]bililive
 ...
 private:
  ...
  void DoRemoveChildView(View* view,
                         ...
                         View* new_parent,
                         bool notifications = true);// bililive [bool notifications = true]
  ...
  void PropagateRemoveNotifications(View* old_parent, View* new_parent,bool notifications = true);// bililive [bool notifications = true];
