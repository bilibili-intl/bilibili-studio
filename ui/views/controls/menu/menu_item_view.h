...
class VIEWS_EXPORT MenuItemView : public View {
 public:
  ...
  void set_requested_menu_position(MenuPosition requested_menu_position) {
    requested_menu_position_ = requested_menu_position;
  }

  // bililive[
  // Returns a reference to MenuConfig to be used with this menu.
  virtual const MenuConfig& GetMenuConfig() const;
 ...
 protected:
  ...
  virtual const gfx::Font& GetFont();
