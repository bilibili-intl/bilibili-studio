...
void NativeTextfieldViews::UpdateCursorColor(){
  SetCursorColor(textfield_->GetCursorColor());
}

SkColor NativeTextfieldViews::GetCursorColor() const {
  return GetRenderText()->cursor_color();
}

void NativeTextfieldViews::SetCursorColor(SkColor color) {
  GetRenderText()->set_cursor_color(color);
  SchedulePaint();
}
