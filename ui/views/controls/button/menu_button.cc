...
const int MenuButton::kMenuMarkerPaddingLeft = 3 /*bililive[*/* ui::GetDPIScale()/*]bililive*/;
const int MenuButton::kMenuMarkerPaddingRight = -1 /*bililive[*/ * ui::GetDPIScale()/*]bililive*/;
