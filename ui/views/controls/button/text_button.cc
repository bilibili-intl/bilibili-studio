...
const int kDefaultIconTextSpacing = 5 /*bililive[*/ * ui::GetDPIScale()/*]bililive*/;

// Preferred padding between text and edge.
const int kPreferredPaddingHorizontal = 6 /*bililive[*/ * ui::GetDPIScale()/*]bililive*/;
const int kPreferredPaddingVertical = 5 /*bililive[*/ * ui::GetDPIScale()/*]bililive*/;

// Preferred padding between text and edge for NativeTheme border.
const int kPreferredNativeThemePaddingHorizontal = 12 /*bililive[*/ * ui::GetDPIScale()/*]bililive*/;
const int kPreferredNativeThemePaddingVertical = 5 /*bililive[*/ * ui::GetDPIScale()/*]bililive*/;
...
const int kFocusRectInset = 3 /*bililive[*/ * ui::GetDPIScale()/*]bililive*/;
